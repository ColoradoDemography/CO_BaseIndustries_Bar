...
var startdata = [853,1435,121,107,2055,607,839,540]; //Load Alamosa County manually for now
...
selectElem.addEventListener('change', function() {
  horizontalBarChartData.datasets.forEach(function(dataset) {
    ...
    window.myHorizontalBar.options.plugins.title.text = selectElem.options[selectElem.selectedIndex].text + " Base Industries, 2023";
  ...
  const date = d3.timeFormat("%B %d, %Y");
	...
	window.myHorizontalBar = new Chart(ctx, {
      ...
      plugins:{
        ...
        title: {
          display: true,
          text: 'Alamosa Base Industries, 2023'
        },
        subtitle: {
          display: true,
